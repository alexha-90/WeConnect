    ...
    app.post('/api/saveNewContentPost', async (req, res) => {
        try {
            ...
            const sql =
                ...
                'tw_comments, sc_post_frequency, sc_followers, sc_story_opens)' +
            ...
            // const params = [newPost.contentMedium, newPost.contentSummary, newPost.contentDescription,
            //     newPost.contentIdealMatch, newPost.yt_UploadFrequency, newPost.yt_VideoLength,
            //     newPost.yt_SubCount, newPost.yt_ViewCount, passportID];
